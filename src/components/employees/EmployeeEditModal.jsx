        ...
        <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
            <DialogContent className="sm:max-w-[500px] p-6">
                ...
                <div className="space-y-6">
                    ...
                    {/* Phone */}
                    <div className="space-y-2">
                        <Label htmlFor="phone" className="text-sm font-medium text-gray-900">전화번호*</Label>
                        <Input
                            id="phone"
                    ...
                    <div className="flex items-center justify-between pt-2">
                        <Label htmlFor="status" className="text-sm font-medium text-gray-900">재직중</Label>
                        <Switch
                            id="status"
                            checked={formData.employment_status === 'active'}
                            onCheckedChange={(checked) => handleChange('employment_status', checked ? 'active' : 'inactive')}
