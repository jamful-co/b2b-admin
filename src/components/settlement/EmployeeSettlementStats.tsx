  ...
  return (
    <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-gray-100">
            <div className="p-8 space-y-2">
              <p className="text-sm text-gray-500">
                총 활성 인원 <span className="text-xs text-gray-400">(전월 기준)</span>
              </p>
              <p className="text-2xl font-bold text-gray-900">101명</p>
            </div>
            <div className="p-8 space-y-2">
              <p className="text-sm text-gray-500">
                신규 인원 <span className="text-xs text-gray-400">(일할 계산 적용)</span>
              </p>
              <p className="text-2xl font-bold text-gray-900">+2명</p>
            </div>
            <div className="p-8 space-y-2">
              <p className="text-sm text-gray-500">
                퇴사자 <span className="text-xs text-gray-400">(일할 공제 적용)</span>
              </p>
      ...
      <Link to={createPageUrl('SettlementDetails')}>
        <Button
          variant="outline"
          className="w-full h-12 bg-white border-gray-200 text-gray-900 font-medium hover:bg-gray-50 flex items-center justify-center gap-2"
        >
          이달 직원별 정산 내역 보기
