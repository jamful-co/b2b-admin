            ...
            <div className="bg-white rounded-lg border border-gray-100 shadow-sm overflow-hidden">
                <Table>
                    <TableHeader className="bg-gray-50">
                        <TableRow>
                            <TableHead className="w-[200px] text-xs font-semibold text-gray-600">이용 월</TableHead>
                            <TableHead className="w-[200px] text-xs font-semibold text-gray-600">확정일</TableHead>
                            ...
                            <TableHead className="w-[150px] text-xs font-semibold text-gray-600 text-center">정산 진행</TableHead>
                        </TableRow>
                    </TableHeader>
                    <TableBody>
                            ...
                            paginatedData.map((item) => (
                                <TableRow key={item.id} className="hover:bg-gray-50/50">
                                    ...
                                    <TableCell className="text-gray-600">
                                        {item.confirmation_date ? format(new Date(item.confirmation_date), 'yyyy-MM-dd') : '-'}
                                    </TableCell>
